...
from PySide6.QtGui import QIcon, QTextCursor, QFont, QPixmap, QColor, QPalette
...
class FlashTool(QMainWindow):
    ...
    def _init_recovery_mode_page(self):
        ...
        self.recovery_flash_btn.setStyleSheet("background-color: #4CAF50; color: white; font-weight: bold; padding: 10px; font-size: 12pt; min-width: 120px;")
